function loadTips(tips) {
	...
	window.setInterval(showHitokoto, tips.cycleTime)
	...
	function showMessage(text, timeout) {
		...
		$(tips.waifu_target).stop()
		$(tips.waifu_target).html(text).fadeTo(200, 1)
		if (timeout === null) timeout = 5000
		hideMessage(timeout)
	}
	function hideMessage(timeout) {
		$(tips.waifu_target).stop().css('opacity', 1)
		if (timeout === null) timeout = 5000
		$(tips.waifu_target).delay(timeout).fadeTo(200, 0)
	}
}
